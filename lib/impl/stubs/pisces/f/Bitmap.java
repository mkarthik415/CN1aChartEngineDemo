 ...
 *  </pre>
 */
public class Bitmap implements pisces.Font.Glyph, pisces.d.Surface {
	...
	public pisces.Font.Glyph blit(pisces.Graphics g, int x, int y, float op) {
	}

	public pisces.Font.Glyph draw(pisces.Graphics g, int x, int y, float op) {
	}
	...
	public pisces.Font.Glyph draw(pisces.d.PathSink sink, int x, int y, float op) {
	}
}
