...
public class Stroker extends LineSink {
	 ...
	 */
	public Stroker(LineSink output, double lineWidth, int capStyle, int joinStyle, double miterLimit, pisces.m.Matrix transform) {
	}
	 ...
	 *  shaped end caps and joins.
	 */
	public void setParameters(double lineWidth, int capStyle, int joinStyle, double miterLimit, pisces.m.Matrix transform) {
	}
