...
public final class Pisces extends PathSink implements Surface.Sink {
	...
	public pisces.Color getColor() {
	}

	public void setColor(pisces.Color color) {
	}

	public void setPaint(Paint paint, pisces.m.Matrix transform) {
	}
	...
	public pisces.m.Matrix getTransform() {
	}
