...
public class Encoder {
	 ...
	 * The image. 
	 */
	protected pisces.d.Surface surface;
	...
	public Encoder(pisces.d.Surface surface) {
	}

	public Encoder(pisces.d.Surface surface, boolean encodeAlpha) {
	}

	public Encoder(pisces.d.Surface surface, boolean encodeAlpha, int whichFilter) {
	}

	public Encoder(pisces.d.Surface surface, boolean encodeAlpha, int whichFilter, int compLevel) {
	}
